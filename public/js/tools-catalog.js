...
window.LUMA_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'gif-optimise',       name: 'Optimise GIF',   where: 'server', desc: 'Shrink GIF without quality loss.', fa: 'fa-compress' },
      { id: 'gif-frame-remove',   name: 'Remove Frames',  where: 'server', desc: 'Drop specific frames.',          fa: 'fa-trash-alt' },
      { id: 'subtitle-burn',      name: 'Burn Subtitles', where: 'server', desc: 'Hard-code SRT onto video.',       fa: 'fa-closed-captioning' },
