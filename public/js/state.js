...
const FILE_TOOL_MAP = {
    'image': [
        ...
        { id: 'images-to-pdf',       label: 'To PDF',           icon: 'fas fa-file-pdf' },
    ...
    'audio': [
        ...
        { id: 'audio-separate',   label: 'Vocal Separator', icon: 'fas fa-guitar' },
        { id: 'metadata-strip',   label: 'Strip Metadata',  icon: 'fas fa-eraser' },
        { id: 'hash-generate',    label: 'Hash File',       icon: 'fas fa-fingerprint' },
    ],
    'pdf': [
        ...
        { id: 'ai-paraphrase',   label: 'Paraphrase',   icon: 'fas fa-sync-alt' },
        { id: 'hash-generate',   label: 'Hash File',    icon: 'fas fa-fingerprint' },
    ],
    'markdown': [
    ...
    'json': [
        { id: 'json-format',    label: 'Format',     icon: 'fas fa-file-code' },
    ...
    'document': [
        ...
        { id: 'ai-quiz',         label: 'Quiz Me',      icon: 'fas fa-question-circle' },
        { id: 'ai-paraphrase',   label: 'Paraphrase',   icon: 'fas fa-sync-alt' },
        { id: 'word-counter',    label: 'Word Count',    icon: 'fas fa-align-left' },
        { id: 'hash-generate',   label: 'Hash File',    icon: 'fas fa-fingerprint' },
    ],
    'text': [
        { id: 'code-beautify',   label: 'Beautify',     icon: 'fas fa-indent' },
        { id: 'diff-checker',    label: 'Diff Check',    icon: 'fas fa-code-compare' },
        { id: 'word-counter',    label: 'Word Count',    icon: 'fas fa-align-left' },
        { id: 'ai-study-notes',  label: 'Study Notes',   icon: 'fas fa-brain' },
        { id: 'ai-paraphrase',   label: 'Paraphrase',    icon: 'fas fa-sync-alt' },
        { id: 'hash-generate',   label: 'Hash File',     icon: 'fas fa-fingerprint' },
